define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'agent_book/book_error/index' + location.search,
                    add_url: 'agent_book/book_error/add',
                    edit_url: 'agent_book/book_error/edit',
                    del_url: 'agent_book/book_error/del',
                    multi_url: 'agent_book/book_error/multi',
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'agent_book/book_error/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
                            ...
                            buttons: [
                                {
                                    ...
                                    url: 'agent_book/book_error/restore',
                                    refresh: true
                                },
                                {
                                    name: 'Destroy',
                                    ...
                                    icon: 'fa fa-times',
                                    url: 'agent_book/book_error/destroy',
                                    refresh: true
                                }
                            ],
