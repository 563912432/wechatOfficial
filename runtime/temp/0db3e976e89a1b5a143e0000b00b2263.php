              ...
              <!--  <li class="hidden-xs">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo htmlentities(cdnurl($agent['avatar'])); ?>" class="user-image" alt="<?php echo htmlentities($agent['nickname']); ?>">
                        <span class="hidden-xs"><?php echo htmlentities($agent['nickname']); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo htmlentities(cdnurl($agent['avatar'])); ?>" class="img-circle" alt="">

                            <p>
                                <?php echo htmlentities($agent['nickname']); ?>
                                <small><?php echo date("Y-m-d H:i:s",$agent['logintime']); ?></small>
                            </p>
                        </li>
                        <!-- Menu Body -->
                        <!--<li class="user-body">
...
<section class="sidebar">
    ...
    <div class="user-panel hidden-xs">
        <div class="pull-left image">
            <a href="general/profile" class="addtabsit"><img src="<?php echo htmlentities(cdnurl($agent['avatar'])); ?>" class="img-circle" /></a>
        </div>
        <div class="pull-left info">
            <p><?php echo htmlentities($agent['nickname']); ?></p>
