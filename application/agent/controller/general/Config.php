...
use app\agent\model\AgentConfig;
use app\common\controller\BackendAgent;
use app\common\library\Email;
use app\agent\model\AgentConfig as ConfigModel;
use think\Exception;
use think\Session;
use think\Validate;
 ...
 */
class Config extends BackendAgent
{
...
//                $this->refreshFile();
    ...
    {
      $config = [];
      foreach (AgentConfig::all() as $k => $v) {
        $value = $v->toArray();
