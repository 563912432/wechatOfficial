...
class Crud extends Command
{
    ...
    protected $fieldSelectpageMap = [
        'nickname' => ['user_id', 'user_ids', 'agent_id', 'agent_ids']
    ];
     ...
     * 保留字段
     */
    protected $reservedField = ['agent_id'];
                ...
                if ($v['COLUMN_KEY'] != 'PRI' && !in_array($field, $this->reservedField) && !in_array($field, $this->ignoreFields)) {
                    ...
                    if ($inputType == 'select') {
                        ...
                        if ($this->isMatchSuffix($field, $this->selectpageSuffix)) {
                            ...
                            } elseif ($selectpageController == 'agent') {
                                $attrArr['data-source'] = 'auth/agent/selectpage';
